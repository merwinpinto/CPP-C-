    ...
    int checkStudent(int idc)
    {
        ...
        else
        {
            while (!read.eof())
            {
                ...
                {
                    flag = 1;
                    if (book1.compare("empty") != 0 && book2.compare("empty") != 0 && book3.compare("empty") != 0)
                    {
                        return 123;
                        break;
                    }
            ...
            while (!read.eof())
            {
                if (book1.compare("empty") != 0 || book2.compare("empty") != 0 || book3.compare("empty") != 0)
                {
                    if (id == x)
                    {
                        ...
                        if (book2.compare("empty") != 0)
                        {
                            cout << " 2 -->> " << book2 << endl;
                        }
                        if (book3.compare("empty") != 0)
                        {
                            cout << " 3 -->> " << book3 << endl;
                        }
